// app/(app)/dashboard/verify/page.tsx
"use client";
...
export default function VerifyControlsPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-10 space-y-6">
      <header>
        <h1 className="text-2xl font-semibold">Verification (dev)</h1>
        <p className="text-sm opacity-70">Owner-only controls for verification.</p>
      </header>
